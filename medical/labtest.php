...
<body>
    <!-- Include same header as index.php -->
        ...
        <nav>
            ...
            <ul class="nav-links">
                <li><a href="index.php"><i class="fas fa-home"></i> Home</a></li>
                 ...
                 <li><a href="#lab-tests"><i class="fas fa-flask"></i> Lab Tests</a></li>
                <li><a href="services.php" class="active"><i class="fas fa-hand-holding-medical"></i> Services</a></li>
...
<div class="slider">
    ...
    <div class="table-container">
        <h2>Laboratory Tests & Pricing</h2>
    ...
    <!-- Include same footer as index.php -->
 <footer>
