...
// Start slider only if there are slides
if(slides.length > 0) {
    // Initialize first slide
    slides[0].classList.add('active');
    
    // Start interval only if multiple slides
    if(slides.length > 1) {
...
<!-- About Section -->
        <section id="about" class="welcome-section">
            <div class="welcome-images">
                <?php
                $query = "SELECT image FROM images WHERE category='about-gallery'";
                $result = $conn->query($query);
                while ($row = $result->fetch_assoc()) {
            ...
            <div class="welcome-content">
                <h2>About Church Army Medical Centre</h2>
                <p>Church Army Medical Centre is a department under Church Army Africa. The hospital was a project started by Rev. Canon. Cpt. Richard W. Mayabi during his tenure as the General Secretary Church Army Africa.</p>

                <p>The hospital was commissioned by the Rt Rev. Joel Waweru Bishop ACK diocese of Nairobi on 19th June 2012.</p>
...
<section class="info-cards">
    <!-- Certifications Card -->
    <div class="info-card">
        <h3><i class="fas fa-certificate"></i> Certifications & Accreditations</h3>
        <ul class="certifications-list">
            <li>Registered by Medical Practitioner And Dentist Board (CAP 253) - License No. 34874</li>
            <li>Laboratory registered by KMLTTB - License No. 1575</li>
            <li>NHIF Accredited with over 1,000 registered members</li>
        </ul>
    </div>
    ...
    <div class="info-card">
        ...
        <ol class="purpose-list">
            <li>Offer health services rooted in philosophy of Christian pastoral care to patients</li>
            <li>Provide exposure to Evangelists training at Church Army School of Missions</li>
        </ol>
    </div>

    <!-- Vision Card -->
    <div class="info-card">
        <h3><i class="fas fa-eye"></i> Our Ultimate Vision</h3>
        <p class="vision-text">
            To empower Evangelists to establish similar healthcare centers in their ministry contexts, 
            offering health services to those they serve.
        </p>
    </div>
</section>
...
<div id="appointmentModal" class="modal">
   ...
   <!-- Team Gallery -->
                <div class="team-gallery">
                    ...
                    <div class="team-grid">
                        ...
                        while ($row = $result->fetch_assoc()) {
                            ...
                            echo '<a href="'.$row['linkedin'].'"><i class="fab fa-linkedin-in"></i></a>';
    ...
    <!-- Keep modal and footer sections the same -->
    <script>
// Modal Handling
